...
class Delete_Post_Widget extends Widget_Base
{
    ...
    {
        return __( 'Delete Post Button', 'acf-frontend-form-element' );
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section( 'delete_button_section', [
            'label' => __( 'Delete Button', 'acf-frontend-form-element' ),
    ...
    protected function render()
    {
        ...
        if ( $display ) {
            echo  '<div class="acfef-delete-button-container"><button class="button acfef-delete-button"><a onclick="return confirm(\'' . $settings['confirm_delete_message'] . '\')" href="' . get_delete_post_link( $post->ID ) . '">' . $settings['delete_button_text'] . '</a></button></div>' ;
        }
    }
